export default {
  ...
  'account.settings.basic.password': 'Password',
  'account.settings.basic.change-password': 'Change Password',
  'account.settings.basic.key': 'Key',
  'account.settings.basic.change-key': 'Change Key',
