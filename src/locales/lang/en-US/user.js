export default {
  ...
  'user.login.tab-login-email': 'Email login',
  'user.login.email.placeholder': 'Email',
  'user.login.email.verification-code.placeholder': 'Verification code',
  ...
  'user.recover': 'Account recovery',
  'user.recover.username.placeholder': 'Employee ID',
  'user.recover.password.placeholder': 'Public Key',
  'user.recover.newpassword.placeholder': 'New Password',
  'user.recover.newpassword.required': 'Please enter your new password!',
  'user.recover.login': 'Recover',
  'user.recover.username.required': 'Please enter your Employee ID!',
  'user.recover.password.required': 'Please enter your Public Key!'
}
