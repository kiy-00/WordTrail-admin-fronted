export default {
  ...
  'user.recover': '账户找回',
  'user.recover.username.placeholder': '工号',
  'user.recover.password.placeholder': '公钥',
  'user.recover.newpassword.placeholder': '新密码',
  'user.recover.login': '恢复',
  'user.recover.username.required': '请输入工号！',
  'user.recover.password.required': '请输入公钥！',
  'user.recover.newpassword.required': '请输入新密码！'
}
